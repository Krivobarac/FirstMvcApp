...
export class AttendantService {
  API_URL = `https://localhost:44378/api/attendant`;
  ...
  populatePersonObject() {
    this.person.firstName = this.personFormModel.controls["firstName"].value;
    this.person.lastName = this.personFormModel.controls["lastName"].value;
    this.person.dateOfBirth = this.personFormModel.controls["dateOfBirth"].value;
  }
